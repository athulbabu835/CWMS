...
$sql="INSERT INTO tblcarwashbooking(bookingId,packageType,carWashPoint,fullName,mobileNumber,washDate,washTime,message,status,email) VALUES(:bno,:ptype,:wpoint,:fname,:mobile,:date,:time,:message,:status,:email)";
...
if($lastInsertId)
{
  ...
  echo '<script>alert("You will get a confirmation message .Booking number is "+"'.$bno.'")</script>';
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                            AUTOHUB comes with several features that makes you avail the best car wash and detailing experience near you</p>
                            <ul>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs</span><strong>100</strong></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs</span><strong>250</strong></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (Rs.100)</option>
                 <option value="2">PREMIUM CLEANING (Rs.250)</option>
...
<?php } ?>
            ...
            <p><input type="email" class="form-control" id="email" placeholder="Email" name="email" required="required"></p>
