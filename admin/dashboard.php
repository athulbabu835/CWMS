		...
		<div class="four-grids">
			...
			<a href="all-bookings.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-agileits min_height">
							<div class="icon">
...
<a href="new-booking.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo min_height">
							<div class="icon">
								<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
...
$newbookings=$query1->rowCount();
		...
		<a href="completed-booking.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-wthree min_height">
							<div class="icon">
							<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3>Approved/Rejected Bookings</h3>
<?php $sql3 = "SELECT id FROM tblcarwashbooking WHERE status = 'Approved' OR status = 'Rejected'";
...
$completedbookings=$query3->rowCount();
	...
	<a href="manage-enquires.php" target="_blank">
			<div class="col-md-3 four-grid">
						<div class="four-w3ls min_height">
							<div class="icon">
