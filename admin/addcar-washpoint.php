...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="contactno" id="contactno" placeholder="Contact Number" required pattern="^[0-9]{10}$" oninvalid="this.setCustomValidity('Please insert 10 digits')" oninput="this.setCustomValidity('')">
									</div>
								</div>
